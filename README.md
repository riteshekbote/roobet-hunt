...
24/7 deep multi-model bug-hunting automation for **Roobet** (Oliver Maicher bug-bounty hub).

Scope: All company-owned infrastructure, gaming platforms, user accounts, wallets, APIs, mobile/web applications, and domains operated by Roobet
...
> is never accepted. Active testing is gated behind the in-scope hosts in `inventory/roobet.md` and
...
Program description: Online cryptocurrency casino platform offering games such as slots, blackjack, and sports betting
